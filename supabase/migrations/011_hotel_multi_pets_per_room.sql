...
-- ===================================
-- 1. สร้างตาราง hotel_rooms (สัตว์เลี้ยงในห้องพัก)
-- ===================================
...
CREATE INDEX idx_hotel_rooms_booking_id ON hotel_rooms(hotel_booking_id);
CREATE INDEX idx_hotel_rooms_pet_id ON hotel_rooms(pet_id);

COMMENT ON TABLE hotel_rooms IS 'สัตว์เลี้ยงที่เข้าพักในแต่ละห้อง (รองรับหลายตัวต่อห้อง)';

-- ===================================
-- 2. Migrate ข้อมูลเก่า: ย้าย pet_id จาก hotel_bookings ไปยัง hotel_rooms
-- ===================================
INSERT INTO hotel_rooms (hotel_booking_id, pet_id, created_at)
...
-- ===================================
-- 5. RLS Policy สำหรับ hotel_rooms
-- ===================================
ALTER TABLE hotel_rooms ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Allow service role full access on hotel_rooms" ON hotel_rooms
